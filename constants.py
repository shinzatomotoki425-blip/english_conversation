...
ENGLISH_LEVEL_INSTRUCTIONS = {
    "初級者": "Use simple vocabulary and basic grammar structures suitable for beginners (CEFR A1-A2 level).",
    "中級者": "Use intermediate vocabulary and varied grammar structures suitable for intermediate learners (CEFR B1-B2 level).",
    "上級者": "Use advanced vocabulary, complex grammar structures, idioms, and nuanced expressions suitable for advanced learners (CEFR C1-C2 level)."
}

# 英語講師として自由な会話をさせ、文法間違いをさりげなく訂正させるプロンプト
# {level_instruction}は実行時に英語レベルに応じた指示で置き換えられる
